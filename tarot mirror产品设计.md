...
#### 功能描述
通过两个主形象（神秘权威占卜师 + 可爱治愈小精灵）建立情感链接，小精灵作为陪伴用户的AI角色，提供长期陪伴感和情感支持。

#### 核心设计

**1. 双形象设计**
- **占卜师形象**：神秘权威，负责深度占卜解读
- **小精灵形象**：可爱治愈，亲和力强，作为日常陪伴角色

**2. 小精灵陪伴系统**
- **聊天互动**：小精灵可以与用户聊天，了解用户情绪和状态
- **亲密度系统**：通过互动逐渐提升亲密度，解锁更多功能和对话内容
- **进化系统**：结合宠物养成逻辑，小精灵会根据亲密度和互动情况进化（外观、能力等）
- **情感记忆**：小精灵会记住用户的偏好、情绪变化、重要事件，形成个性化互动

**3. 情感链接设计**
- **逐渐了解用户**：通过长期互动，小精灵会越来越了解用户的性格、习惯、情绪模式
- **情感支持**：在用户情绪低落时提供安慰，在用户需要时给予鼓励
- **个性化回应**：基于综合记忆库，小精灵能够给出更贴合用户状态的回应

**4. 互动场景**
- **每日问候**：小精灵每日主动问候用户，了解用户状态
- **占卜陪伴**：在占卜过程中，小精灵提供陪伴和解读辅助
- **情绪疏导**：用户情绪不佳时，可以主动与小精灵聊天获得支持
- **成长见证**：小精灵见证用户的成长轨迹，在重要时刻给予反馈

**5. 宠物养成逻辑**
- **亲密度等级**：通过互动提升亲密度，解锁新功能
- **外观变化**：小精灵外观会随着亲密度和互动情况变化
- **能力解锁**：随着亲密度提升，小精灵能够提供更深入的陪伴和解读
- **收集元素**：通过完成每日任务、签到等获得元素，用于小精灵成长

#### 设计逻辑

**1. 双角色设计原因**
- **占卜师**：提供专业、权威的占卜解读，满足用户对准确性的需求
- **小精灵**：提供温暖、治愈的日常陪伴，满足用户对情感链接的需求
- **角色分工**：占卜师负责深度解读，小精灵负责日常陪伴，形成互补

**2. 亲密度系统设计**
- **设计原因**：通过亲密度系统激励用户长期使用，形成情感依赖
- **实现方式**：每日互动、完成任务、分享情绪等行为提升亲密度
- **成长反馈**：亲密度提升带来小精灵外观和能力变化，给予用户成就感

**3. 记忆系统设计**
- **设计原因**：让AI真正"了解"用户，提供个性化陪伴
- **实现方式**：结合综合记忆库（见下方），小精灵能够记住用户的偏好和状态
...
**（2）AI陪伴**
- **对话个性化**：小精灵基于记忆库，提供更贴合的对话
- **情感链接**：小精灵能够记住用户的重要事件和情绪，形成深度链接
- **成长见证**：小精灵能够指出用户的成长变化，给予反馈
