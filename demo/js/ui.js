...
function renderWeeklyCalendar() {
    ...
    weekdayRow.className = 'weekly-weekday-row';
    
    const iconRow = document.createElement('div');
    iconRow.className = 'weekly-icon-row';
    
    const dateRow = document.createElement('div');
    dateRow.className = 'weekly-date-row';
    ...
    for (let i = 0; i < 7; i++) {
        ...
        // 将三个单元格放入按钮容器
        dayButton.appendChild(weekdayCell.cloneNode(true));
        dayButton.appendChild(iconCell.cloneNode(true));
        dayButton.appendChild(dateCell.cloneNode(true));
